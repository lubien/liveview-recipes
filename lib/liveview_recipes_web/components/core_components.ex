defmodule LiveviewRecipesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveviewRecipesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveviewRecipesWeb.Gettext, "errors", msg, opts)
    end
  end
